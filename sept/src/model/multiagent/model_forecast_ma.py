...
class ModelForecastMultiAgent(nn.Module):
    ...
    def forward(self, data):
        ...
        one_hot_mask = self.one_hot_mask  # torch.eye (6*6) 这个one hot mask 是一个对角线为1,其余为0的单位矩阵

        x_actors = torch.cat( # 将one hot mask 跟actor feat 统一到四维， 沿着最后一个维度相加， 【1,6,16,134】
