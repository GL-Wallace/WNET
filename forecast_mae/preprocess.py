...
from src.datamodule.av2_augmentation import Av2Augmentation
...
def preprocess(args):
    ...
    for mode in ["train", "val", "test"]:
        ...
        elif args.agent == "augmentation":
            save_dir = data_root.parent / "forecast-mae-augmentation" / mode
            extractor = Av2Augmentation(save_path=save_dir, mode=mode)
        else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_root", "-d", type=str, required=False, default='/home/user/Documents/argoverse2_forecast_mae')
    parser.add_argument("--batch", "-b", type=int, default=1)
    parser.add_argument("--parallel", "-p", action="store_true")
    parser.add_argument("--agent", "-a", choices=["single", "multi", "augmentation"], default="augmentation")
