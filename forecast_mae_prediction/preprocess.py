...
from forecast_mae_prediction.src.datamodule.av2_extractor import Av2Extractor
from src.datamodule.av2_extractor_multiagent import Av2ExtractorMultiAgent
from forecast_mae_prediction.src.utils.ray_utils import ActorHandle, ProgressBar

ray.init(num_cpus=16)

class Args:
    def __init__(self, data_root, batch=50, parallel=False, multiagent=False):
    ...
    for mode in ["train", "val", "test"]:
        ...
        if args.parallel:
            ...
            for i in range(0, len(scenario_files), batch):
                print(i, 'of the ', len(scenario_files) )
...
if __name__ == "__main__":
    ...
    args = Args("/home/user/Projects/raw_data/argoverse2/raw_argo_partly/raw", batch=2, parallel=False, multiagent=False)
    preprocess(args)